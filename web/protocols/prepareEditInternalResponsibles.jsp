...
<p class="breadcumbs">
	...
	<span><strong><bean:message key="label.protocol.edit.step2" bundle="PROTOCOLS_RESOURCES"/></strong></span> > 
...
<fr:form action="/protocols.do?method=prepareEditExternalResponsibles">
